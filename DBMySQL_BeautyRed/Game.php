...
$people_id = $_GET['PeopleID'];
$DataRow = $people_id - 1; //資料庫是從第0列開始，而id從1開始
...
//***挑戰人氣增加***
$query = "SELECT `Img`,`popularity`,`website` FROM `Schl_Upload`";
if($query_run = mysql_query($query)){
	$WebSite = mysql_result($query_run,$DataRow,'website');
	$Img = mysql_result($query_run,$DataRow,'Img');
	$Popularity = mysql_result($query_run,$DataRow,'popularity');
	$Popularity++;
}

$update_query = "UPDATE `Schl_Upload` SET `popularity` = '$Popularity' WHERE `id`= '$people_id'";
...
<link rel="shortcut icon" type="image/x-icon" href="Image/WebIcon.jpg" />
...
<script type='text/javascript'>
	function Explanation(){
		...
		<!--<img src="uploads/<?php echo $Img;?>" alt = "Img" id = "Img" width="0" height="0"/>-->
		
		<div>
		<div style = "float:left; margin-left:30px;"><a href="BeautyRed.php"><img src="Image/WebName2.jpg"/></a></div>
		<div style = "float:right; margin-right:30px;"><a href="https://www.facebook.com/BeautyRed-674630072703276/"><img src="Image/FB-icon.png"></a></div>
		<div style="float:right; margin-right:30px;"><img src="Image/Explanation2-icon.png" onclick="Explanation()" style="cursor:pointer;""></div>
		</div>	
		<br><br><br>
		<hr>
		...
		<a href="http://longnice.clouds.twgogo.org/BeautyRed.php"><img src = "../Image/Return.jpg" /></a>
		</div>
		...
		<a target = "_blank" href="http://www.facebook.com/share.php?u=http://longnice.comxa.com/Game.php?PeopleID=<?php echo $index;?>"><img src = "Image/fb-share-icon.png" /></a>
		</div>
		<div style="float:right;margin-left:10px;">
		<a target = "_blank" href="http://www.twitter.com/home/?status=longnice.comxa.com/Game.php?PeopleID=<?php echo $index;?>"><img src = "Image/twitter-share-icon .png" /></a>
		</div>
		</div>
		</div>	
		<div align = "center">
		...
		//***圖片讀取完成事件***
		var image = new Image();
		image.src = "uploads/<?php echo $Img;?>";
		...
		function CheckAnswer(){
			...
			window.open("http://longnice.comxa.com/uploads/<?php echo $Img;?>");
			window.location.assign("http://longnice.clouds.twgogo.org/BeautyRed.php");
			}
		}
